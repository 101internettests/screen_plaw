...
class TestMolStreetPage:
    ...
    def test_transition_search_page_from_perelinkovka(self):
        ...
        with sync_playwright() as playwright:
            ...
            tohome_page.check_address_page_mol_bal()
    ...
    def test_application_search_providers_quiz(self):
        ...
        with sync_playwright() as playwright:
            ...
            block_page.click_search_querti()
            ...
            wind_page.fill_the_application_with_address_only_house()
            main_page = SearchFromMain(page=page)
            time.sleep(4)
            main_page.check_quiz()
            time.sleep(4)
    ...
    def test_people_perelinkovka(self):
        ...
        with sync_playwright() as playwright:
            ...
            perelinkovka_page.click_granichnaya_street()
            time.sleep(2)
            perelinkovka_page.click_other_streets()
            perelinkovka_page.click_energetich_street()
            time.sleep(2)
            perelinkovka_page.click_other_streets()
            perelinkovka_page.click_nosobich_street()
