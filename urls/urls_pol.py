...
urls_stage = [
    ...
    host_stage + "piter-online.net/ratesmobile/bez-abonentskoj-platy",
    ...
    host_stage + "piter-online.net/ratesmobile/bezlimitnaja-svjaz",
    host_stage + "piter-online.net/ratesmobile/dlja-plansheta",
